# Apêndice B: Templates Quarto e Automação {.unnumbered}
...
# Exemplo ilustrativo (não executado)
# library(tidyverse)
# dados <- data.frame(...)
...
**Próximo capítulo:** Nome do próximo
```
...
- Usar CI/CD para deploy automático

❌ **Evitar:**
- Commitar arquivos gerados (`_book/`, `docs/`)
- Dados grandes sem Git LFS
- Executar código demorado sem cache
